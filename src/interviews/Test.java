...
/*	public static void main(String[] args){
	...
	public static void main(String[] args){
		...
		List<Integer> myList2 = new ArrayList<Integer>(Arrays.asList(myArr2));
		...
		List<Integer> myList3 = new ArrayList<Integer>(Arrays.asList(myArr5));		
		     //OR
		List<Integer> myList4 = new ArrayList<Integer>(Arrays.asList(ArrayUtils.toObject(myArr)));	
